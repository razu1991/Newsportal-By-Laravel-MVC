...
test('require_from_group', function() {
	$("#NewsInfo").validate({
		rules: {
			partnumber:  {require_from_group: [2,".NewsInfo"]},
			description: {require_from_group: [2,".NewsInfo"]},
			discount: {require_from_group: [2,".NewsInfo"]}
		}
	});

	fillFormWithValuesAndExpect('#NewsInfo', [], false);
	fillFormWithValuesAndExpect('#NewsInfo', [123], false);
	$('#NewsInfo input[type="checkbox"]').attr('checked', 'checked');
	fillFormWithValuesAndExpect('#NewsInfo', [123], true);
	$('#NewsInfo input[type="checkbox"]').removeAttr('checked');
	fillFormWithValuesAndExpect('#NewsInfo', [123, 'widget'], true);
	fillFormWithValuesAndExpect('#NewsInfo', [123, 'widget', 'red'], true);
	fillFormWithValuesAndExpect('#NewsInfo', [123, 'widget', 'red'], true);
});
...
test('skip_or_fill_minimum', function() {
	$("#NewsInfo").validate({
		rules: {
			partnumber:  {skip_or_fill_minimum: [2,".NewsInfo"]},
			description: {skip_or_fill_minimum: [2,".NewsInfo"]},
			color:       {skip_or_fill_minimum: [2,".NewsInfo"]}
		}
	});

	fillFormWithValuesAndExpect('#NewsInfo', [], true);
	fillFormWithValuesAndExpect('#NewsInfo', [123], false);
	fillFormWithValuesAndExpect('#NewsInfo', [123, 'widget'], true);
	fillFormWithValuesAndExpect('#NewsInfo', [123, 'widget', 'red'], true);
});
